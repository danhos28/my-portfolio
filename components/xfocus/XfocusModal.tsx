  ...
  return (
    <Backdrop onClick={handleClose}>
      <motion.div
        ...
        className="rounded-md flex flex-col justify-center items-center gap-6 max-h-[85vh] text-black dark:text-white lg:flex-row shadow-lg px-6 py-10 lg:p-12 md:py-8 sm:p-10 bg-white dark:bg-darkTwo w-[95%] sm:w-[85%] max-w-screen-xl font-body"
        variants={dropIn}
        initial="hidden"
        animate="visible"
        exit="exit"
      >
        <div className="overflow-y-scroll lg:overflow-hidden h-full px-4 pb-2  flex flex-col justify-start items-center lg:items-start gap-6 lg:flex-row">
          ...
          <div className="pt-2 flex flex-col gap-2 w-full lg:w-[40%]">
            ...
            <p className="text-sm lg:text-base">
              ...
              Android OS so the clients can monitor their business through
              phone. This application was developed using Android Studio.
            </p>
            ...
            <div className="flex gap-2 text-sm lg:text-base mt-4">
              <p className="hidden md:block">Source Code: </p>
              <p className="block md:hidden">Code: </p>
              <a
                target="_blank"
                rel="noreferrer noopener"
                href="https://github.com/danhos28/Xfocusr"
                className="text-primary dark:text-light  cursor-pointer hover:text-darkTwo"
              >
                <p className="hidden md:block">
                  https://github.com/danhos28/Xfocus
                </p>
                <p className="block md:hidden">github.com/danhos28/Xfocus</p>
              </a>
            </div>
