...
const Xfocus = ({ animationOne }: any) => {
  ...
  return (
    <div className="relative w-screen" ref={animationOne.ref}>
      <div className="relative max-w-screen-lg w-full sm:w-3/4 py-4 md:gap-6 flex flex-col justify-center items-center md:flex-row md:justify-start mx-auto">
        <div className="w-full sm:w-3/4 h-full bg-contain bg-xfocus rounded-t-lg md:rounded-lg overflow-hidden">
          <div className="w-full h-full bg-gradient-to-b from-[#adacf0c5] to-[#311d79bd] flex items-center justify-center">
            <motion.img
              animate={animationOne.animation}
              src="/images/xfocus_thumb.png"
              alt="xfocus-thumb"
              className="w-full md:w-2/3 max-w-[380px] py-8"
            />
          </div>
        </div>

        <div className="md:absolute right-2 flex flex-col justify-center items-center md:items-start gap-2 w-full bg-white dark:bg-darkTwo sm:w-3/4 md:w-[40%] p-8 rounded-lg shadow-lg">
