        ...
        <div className="overflow-y-scroll lg:overflow-hidden h-full px-4 pb-2  flex flex-col justify-start items-center lg:items-start gap-6 lg:flex-row">
          ...
          <div className="pt-2 flex flex-col gap-2 w-full lg:w-[40%]">
            ...
            <p className="text-sm lg:text-base">
              Drive safely is an Android app that can detect and alert the
              drivers using alarm when they fall asleep or speeding. This app
              used Google Vision API to detect eyes and GPS for tracking the
              velocity.
            </p>
