    ...
    <Backdrop onClick={handleClose}>
      ...
      >
        ...
        <div className="flex flex-col gap-4 w-full lg:w-[40%]">
          <h1 className="text-2xl">Cheapero</h1>
          <p className="text-sm sm:text-base">
            Cheapero is a Ecommerce web app created using React and Strapi. This
            website implemented PWA to let users install the app and access it
            offline.
          </p>
