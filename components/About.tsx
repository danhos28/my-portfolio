...
const About = ({ isDark }: { isDark: boolean }) => {
  return (
    <div className="relative w-screen py-8 text-black dark:text-light font-body">
      <div className="flex flex-col text-center jus gap-6 w-full max-w-screen-lg sm:w-3/4 md:3/5 h-full justify-center items-center m-auto p-4">
        <div className="flex flex-col gap-2">
          <h1 className="text-xl sm:text-2xl font-semibold">About Me</h1>
          <p>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Sit tempore
            earum laborum nam quod, quasi perspiciatis magnam voluptate odio
            dicta eligendi enim omnis. Fuga at accusantium voluptatum quia, ut
            nobis?
          </p>
        </div>
        <Button>
        ...
        <h1 className="font-bold">My Personal Journey</h1>
        <div className="grid-qualification gap-4 relative">
          <div className="flex flex-col h-full justify-between">
            <li className="list-none flex flex-col items-center sm:items-end">
              <div className="flex gap-1">
                <p className="text-sm font-bold">Smak Penabur Cirebon</p>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <p className="text-xs">2014 - 2017</p>
            </li>

            <li className="list-none flex flex-col items-center sm:items-end">
              <div className="flex items gap-1">
                <p className="text-sm font-bold">President University</p>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-4 w-4 hidden sm:block"
                  fill="none"
              ...
              <p className="text-xs">Information Technology (GPA 3.56)</p>
          ...
          <div className="flex flex-col h-full justify-center">
            <li className="list-none flex flex-col items-center sm:items-start">
              <div className="flex items gap-1">
                <p className="text-sm font-bold">PT. Tiga Inti Perkasa</p>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-4 w-4 hidden sm:block"
                  fill="none"
              ...
              <p className="text-xs">Android Developer (Internship)</p>
              <p className="text-xs">Oct 2020 - Feb 2021</p>
            </li>
          </div>
        </div>
      </div>
